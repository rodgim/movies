...
class UnrevealRectangularShapeAnimator : ShapeAnimator {
            ...
            .addUpdateListener { valueAnimator ->
                ...
                rectangularShape.currentWidth = (
                    floatEvaluator!!.evaluate(
                        fraction, rectangularShape.minWidth,
                        rectangularShape.maxWidth
                    )
                )
                if (rectangularShape.currentHeight == rectangularShape.maxHeight) {
